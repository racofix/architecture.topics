...
class GetMoveDetailsUseCase @Inject constructor(private val repository: MovieRepository) :
    UseCase<Params, Movie>() {

    data class Params(val id: Int)

    override fun executeFlow(params: Params): Flow<Result<Movie>> =
